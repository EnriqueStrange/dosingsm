"""CODE BY ENRIQUE STRANGE"""

import requests
import time
import pyfiglet

username = input('\033[1;31;40m {+} Enter the username to DOX-->> ')
...
''' BANNER '''
def banner():
    result = pyfiglet.figlet_format("SEARCHING..", font = "digital"  ) 
    print(result) 
